...
if(isset($_POST['search'])){
    ...
    $sql = "SELECT * FROM exam_results WHERE courseCode='$courseCode' AND session='$session_input' AND studentId='$studentId'";
    $res = $conn->query($sql);
    if($res->num_rows>0){
...
<div class="container">
<div class="header">
<h1><i class="fas fa-file-alt"></i> Exam Results </h1>
...
<button class="btn" onclick="window.location.href='student_dashboard.php'" style="margin-left:10px;">
    <i class="fas fa-home"></i> Go to Dashboard
</button>

<button class="btn" onclick="window.location.href='student_logout.php'" style="margin-left:10px; background:red;">
...
function downloadPDF(){
    ...
    doc.autoTable({head:[['Exam No','Total Marks','Score','Submission Time']],body:rows,startY:30});
